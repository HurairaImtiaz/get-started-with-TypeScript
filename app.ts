var number1:number= 700;
var number2:number= 800;
console.log("your number is =", number1);
console.log("your number is =", number2);
var Name:string= "Huraira Imtiaz";
...
// 1) AND OERATOR
var logicalOperator:boolean= number1 == number2 && number1 != number2;
